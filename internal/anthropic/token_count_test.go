...
func TestCountInputTokensCountsEffectiveCodexInput(t *testing.T) {
	...
	count, err := CountInputTokens(translate.NormalizedRequest{Request: codex.Request{
		Model:        "gpt-5.4",
...
func TestCountInputTokensDoesNotTokenizeBase64ImagePayloads(t *testing.T) {
	...
	count := func(payload string) int64 {
		value, err := CountInputTokens(translate.NormalizedRequest{Request: codex.Request{
			Model: "gpt-5.4",
